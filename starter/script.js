...
function getPasswordOptions() {
  ...
  if (hasLowerCasedCharacters === false && hasUpperCasedCharacters === false && hasSpecialCharacters === false && hasNumericCharacters === false){
    alert(`Must select atleast one type`);
    return;
  }
